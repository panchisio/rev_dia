...
class Complex:
    ...
    def __init__(self, zonales):
        ...
        consulta = "Select Top 100 gnlDate, gnlStatus, count(*) as Cantidad From General Where rotCode in (Select rotCode From route Where rotInactive= 0 and _deleted= 0) Group By gnlDate, gnlStatus Order By gnlDate Desc"

        consulta2 = "select top 2 rotcode, jrnCode from general where rotcode in(select rotcode from route where _deleted='0' and rotInactive='0')"
