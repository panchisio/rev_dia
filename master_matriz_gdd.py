...
class Complex:
    ...
    def __init__(self, zonales):
        ...
        consulta = "Select Top 10 disCode, didCode, didName, didOrder, didSince, didUntil, didActualDiscount, didStrategy From discountDetail Where didName like'MAT%' Order By didUntil Desc"
